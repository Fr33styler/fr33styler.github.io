...
function addTask(idValue, taskValue, progressValue, noteValue, dateTimeValue, priorityValue, statusValue) {
  ...
  editButton.addEventListener("click", () => {
    ...
    switch (statusBox.childNodes[1].nodeValue) {
      case "Finished":
    ...
    if (response.ok) {
      switch (status.value) {
        case "finished":
          ...
          statusBox.childNodes[1].nodeValue = "Finished";
          break;
        case "in-progress":
          statusBox.style.backgroundColor = "#F57C00";
          statusBox.childNodes[1].nodeValue = "In Progress";
          break;
        case "unfinished":
          statusBox.style.backgroundColor = "#E53935";
          statusBox.childNodes[1].nodeValue = "Unfinished";
          break;
        default:
      }
    }
